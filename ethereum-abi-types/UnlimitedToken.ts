...
export type ContractContext = EthersContractContextV5<
  UnlimitedToken,
  UnlimitedTokenMethodNames,
  UnlimitedTokenEventsContext,
  UnlimitedTokenEvents
>;
...
export type UnlimitedTokenEvents = 'Approval' | 'Transfer';
export interface UnlimitedTokenEventsContext {
  Approval(...parameters: any): EventFilter;
  Transfer(...parameters: any): EventFilter;
}
export type UnlimitedTokenMethodNames =
  | 'new'
  | 'addOperator'
  | 'allowance'
  | 'approve'
...
export interface UnlimitedToken {
  /**
   * Payable: false
   * Constant: false
