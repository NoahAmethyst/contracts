...
export type ContractContext = EthersContractContextV5<
  IGameData,
  IGameDataMethodNames,
  IGameDataEventsContext,
  IGameDataEvents
>;
...
export type IGameDataEvents = undefined;
export interface IGameDataEventsContext {}
export type IGameDataMethodNames =
  | 'addBuffPlayers'
  | 'addPlayer'
  | 'editGameRound'
  | 'getAppGames'
...
export interface GetGameTicketResponse {
  isEth: boolean;
  0: boolean;
  token: string;
  1: string;
