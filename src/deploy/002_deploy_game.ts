...
const deployTest: DeployFunction = async function (
    ...
    let deployed_game_contract = await deploy(game, {
        ...
        log: true,
        // nonce: 8,
        args: [operator, deployed_data_contract.address, deployed_game_data_contract.address, "0x8464135c8F25Da09e49BC8782676a84730C318bC", 100000000]
    });
    ...
    await gameDataOperation.addOperator(deployed_game_contract.address.toString())
    ...
    let _game: [BigNumberish, BigNumberish, string, BigNumberish,
        ...
        string[], boolean, string, BigNumberish,
